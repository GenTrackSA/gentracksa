        ...
        <div className="container relative z-20 py-20 md:py-28">
          <div className="max-w-3xl">
            <motion.h1
              ...
              className="text-4xl md:text-6xl font-extrabold leading-tight text-[#1a120b] drop-shadow-[0_2px_12px_rgba(255,240,210,0.55)]"
            >
              Wildlife genetics that turns{" "}
              <span className="text-amber-200">DNA</span> into decisions.
            </motion.h1>

            <p className="mt-6 text-[#2a1d12] text-lg md:text-xl max-w-2xl drop-shadow-[0_2px_12px_rgba(255,240,210,0.5)]">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="#services"
                className="rounded-2xl px-6 py-3 border border-white/40 bg-white/10 hover:bg-white/20 text-[#1a120b] font-semibold drop-shadow-[0_2px_12px_rgba(255,240,210,0.5)]"
              >
                Explore services
              </a>
            </div>

            <div className="mt-8 flex flex-wrap items-center gap-6 text-sm text-[#2a1d12]/90 drop-shadow-[0_2px_12px_rgba(255,240,210,0.45)]">
