  ...
  return (
    <div className="min-h-screen bg-[#f6f2e8] text-[#1f1f1f]">
      ...
      <section className="relative overflow-hidden isolate">
        ...
        {/* Warm light overlays (for dark text) */}
        <div className="absolute inset-0 z-10 bg-white/55" />
        <div className="absolute inset-0 z-10 bg-gradient-to-b from-white/70 via-white/45 to-transparent" />
        <div className="absolute inset-0 z-10 bg-[radial-gradient(60%_60%_at_25%_10%,rgba(214,199,166,0.35),transparent_65%)]" />
        <div className="absolute inset-0 z-10 bg-[radial-gradient(50%_50%_at_80%_15%,rgba(122,140,88,0.18),transparent_70%)]" />
