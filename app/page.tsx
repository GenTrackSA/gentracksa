    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: "url(/images/hero-rhino1.jpg)" }}
        />

        {/* Warm overlays for readability + safari feel */}
        <div className="absolute inset-0 -z-10 bg-gradient-to-b from-black/80 via-black/55 to-[#080706]/95" />
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(60%_60%_at_25%_10%,rgba(214,199,166,0.22),transparent_60%)]" />
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(50%_50%_at_80%_15%,rgba(122,140,88,0.18),transparent_65%)]" />
        ...
        <div className="container py-20 md:py-28 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="#services"
                className="rounded-2xl px-5 py-3 border border-[rgba(214,199,166,0.35)] hover:bg-white/5"
              >
                Explore services
              </a>
            </div>
      ...
      {/* Trust bar */}
      <section className="py-6 border-y border-white/10 bg-black/30 backdrop-blur">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <a
              key={f.title}
              href={f.href}
              className="rounded-3xl p-6 border border-white/10 bg-black/30 backdrop-blur hover:bg-white/[0.06] block"
            >
      ...
      <section id="case-studies" className="container py-20">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {[
            ...
            <article
              key={title}
              className="group rounded-3xl overflow-hidden border border-white/10 bg-black/30 backdrop-blur"
            >
              <div className="aspect-[16/10] bg-[radial-gradient(circle_at_70%_30%,rgba(214,199,166,0.22),transparent_60%)]" />
              <div className="p-6">
                <h3 className="font-semibold">{title}</h3>
                <p className="mt-2 text-sm text-slate-200/80">
                  Outcomes: decision-ready estimates, method transfer, and
                  practical protocols.
                </p>
                <div className="mt-4 inline-flex items-center gap-1 text-[#d6c7a6] text-sm">
                  Request summary →
          ...
          {[
            ...
            <div
              ...
              className={`rounded-3xl p-6 border backdrop-blur ${
                i === 1
                  ? "border-[rgba(214,199,166,0.35)] bg-[#d6c7a6]/10"
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-3 text-slate-200/80 max-w-lg">
              ...
              decision you need to make. We’ll reply with options and a ballpark
              quote.
            </p>

            <div className="mt-6 space-y-3 text-slate-100">
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 rounded-xl bg-white/10 grid place-content-center">
                  📧
                </span>
...
function ContactForm() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="rounded-3xl p-6 border border-white/10 bg-black/30 backdrop-blur"
    >
